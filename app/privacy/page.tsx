...
const sections: { title: string; body: React.ReactNode }[] = [
    {
        ...
        body: (
            <p>
                단풍지지(이하 &apos;서비스&apos;)는 별도의 회원가입 및 로그인 기능을 제공하지 않으며, 이용자가 직접
                입력하는 개인정보(이름, 이메일, 전화번호 등)를 서버에 수집·저장하지 않습니다.
            </p>
        ),
    },
    {
        ...
        body: (
            <p>
                최근 검색어와 즐겨찾기 기능은 이용자의 브라우저 localStorage에만 저장되며, 서비스 서버로 전송되지
                않습니다. 브라우저 데이터를 삭제하거나 서비스 내 삭제 기능을 사용하면 즉시 제거됩니다.
            </p>
        ),
    },
    {
        ...
        body: (
            <>
                <p>
                    서비스 이용 과정에서 방문 통계 및 서비스 개선을 위해 아래 분석 도구가 접속 기기 정보, IP 주소, 방문
                    페이지, 브라우저 종류 등의 정보를 자동으로 수집할 수 있습니다.
                </p>
    ...
    },
    {
        ...
        body: (
            <p>
                서비스는 Google 애드센스 등 제3자 광고를 게재하고 있습니다. 해당 광고 서비스는 맞춤형 광고 제공을 위해
                쿠키 및 광고 식별자를 사용할 수 있습니다. 이용자는 브라우저 설정 또는
                <a
    ...
    },
    {
        ...
        body: (
            <p>
                서비스에서 제공하는 캐릭터·랭킹 정보는 NEXON Open API를 통해 제공되며, 넥슨 및 메이플스토리와 공식적으로
                제휴되어 있지 않습니다.
            </p>
        ),
    },
