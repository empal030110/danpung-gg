...
const sections: { title: string; body: React.ReactNode }[] = [
    {
        ...
        body: (
            <p>
                단풍지지는 NEXON Open API를 기반으로 메이플스토리 캐릭터와 길드 정보를 조회할 수 있는 비공식 조회
                서비스입니다. 캐릭터 검색 한 번으로 스탯, 장비, 스킬, 유니온, 코디, 업적, 무릉도장 기록까지 한
                페이지에서 확인할 수 있고, 길드명으로는 길드원 목록과 노블레스 스킬 현황을 살펴볼 수 있습니다.
                무릉도장·더시드·업적 랭킹 1위 캐릭터와 최신 공지·업데이트 소식도 메인 화면에서 바로 확인할 수 있습니다.
            </p>
        ),
    },
    {
        ...
        body: (
            <>
                ...
                <ul className="list-disc pl-[20px] mt-[8px] flex flex-col gap-[4px]">
                    <li>
                        <b>장비</b> — 세트 효과, 심볼(아케인/어센틱), 어빌리티, 착용 장비·안드로이드·타이틀, 펫 정보
                    </li>
                    <li>
                        <b>스탯</b> — 하이퍼 스탯, 기본 스탯, 상세 스탯(공격력·방어율 무시·크리티컬 등)
                    </li>
                    <li>
                        <b>스킬</b> — 헥사 스탯 코어, 6차·5차 스킬, 링크 스킬 프리셋
                    </li>
                    <li>
                        <b>유니온</b> — 유니온 레벨, 챔피언 배치, 아티팩트 효과, 공격대원 스탯
                    </li>
                    <li>
                        <b>코디</b> — 캐시 아이템 코디 및 프리셋
                    </li>
                    <li>
                        <b>기타</b> — 업적 등급·점수, 무릉도장 최고 기록
                    </li>
                </ul>
            </>
        ),
    },
    {
        ...
        body: (
            <p>
                상단 네비게이션의 <b>길드</b> 메뉴로 이동한 뒤, 월드(서버)와 길드명을 입력하면 길드 상세 페이지로
                이동합니다. 길드 페이지에서는 길드 마크와 기본 정보, 길드원 목록(스크롤로 전체 확인 가능), 그리고
                노블레스 스킬 보유 현황을 확인할 수 있습니다.
            </p>
        ),
    },
    {
        ...
        body: (
            <p>
                검색창을 클릭하면 최근에 조회한 캐릭터 목록과 즐겨찾기로 등록한 캐릭터 목록이 탭으로 구분되어
                나타납니다. 자주 찾아보는 캐릭터는 즐겨찾기에 등록해두면 매번 이름을 입력하지 않아도 빠르게 다시 조회할
                수 있습니다. 최근 검색어와 즐겨찾기 목록은 서버에 저장되지 않고 이용 중인 브라우저에만 저장되므로, 다른
                기기·브라우저에서는 별도로 표시되지 않습니다.
            </p>
        ),
    },
    {
        ...
        body: (
            <div className="flex flex-col gap-[16px]">
                ...
                <div>
                    ...
                    <p className="mt-[4px]">
                        A. 아닙니다. 단풍지지는 넥슨 Open API를 활용해 개인이 제작한 비공식 서비스이며, 넥슨 및
                        메이플스토리와 공식적으로 제휴되어 있지 않습니다.
                    </p>
                </div>
                <div>
