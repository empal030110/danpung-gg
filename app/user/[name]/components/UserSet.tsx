    ...
    return (
        <div className="w-full">
            ...
            <div className="flex flex-col gap-[8px]">
                {data.filter((effect: userSetProps) => (effect.set_option_full?.[0]?.set_count ?? 0) <= (effect.total_set_count ?? 0)).map((effect: userSetProps) => (
                    <div key={effect.set_name} className="relative group">
                        ...
                        <div className={`${selectedSet === effect.set_name ? 'flex' : 'hidden group-hover:flex'} flex-col gap-[4px] absolute bottom-full z-20 bg-[#111111] p-[16px] rounded-[16px] w-full max-h-[500px] overflow-y-auto scrollbar-hide`}>
